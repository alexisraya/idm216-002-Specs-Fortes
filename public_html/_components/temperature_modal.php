    ...
    <div class="temperature_images">
        ...
        <label class="" for="rare">
            <div class="temperature_image js-rare-btn">
                <img class="temperature_image--img js-rare-btn-img" src="<?php echo site_url();?>/_dist/images/customize_page/ion_rare.svg" alt="rare">
        ...
        <label class="" for="medium">
            <div class="temperature_image temperature_selected js-medium-btn">
                <img class="temperature_image--img js-medium-btn-img" src="<?php echo site_url();?>/_dist/images/customize_page/ion_medium.svg" alt="medium">
        ...
        <label class="" for="well-done">
            <div class="temperature_image js-well-done-btn">
                <img class="temperature_image--img js-well-done-btn-img" src="<?php echo site_url();?>/_dist/images/customize_page/ion_well-done.svg" alt="well done">
